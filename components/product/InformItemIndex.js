        ...
        <article className="max-w-sm mx-auto md:max-w-none grid md:grid-cols-2  md:gap-8 lg:gap-12 xl:gap-16 items-center">
            ...
            <div>
                <header>
                    ...
                    <div className="news-card__post-date flex"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
</svg>
<div className=" ml-2"></div><p className="text-base text-gray-400/95">{ConvertDate(product.createdAt)}</p></div>
                </header>
