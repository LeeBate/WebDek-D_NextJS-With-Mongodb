...
const DetailInform = (props) => {
    ...
    return(
        ...
        <div className="mt-5">
            ...
            <div class="absolute left-2/2 -ml-0.5 w-1.5 rounded-md h-16 bg-gray-600"></div>
            <div className='lg:w-1/2'> <h1 className="font-blod text-base md:text-xl lg:whitespace-normal ml-4">{product.title}</h1></div>
            </div>
            <div className="flex flex-col mx-4 sm:flex-col md:flex-col xl:flex-row sm:mx-4 md:mx-14 xl:mx-24 ">
                ...
                className="img-thumbnail rounded mt-4 sm:mr-5 sm:max-w-xs sm:max-h-10 md:max-w-2xl md:max-h-fit xl:max-w-xl xl:max-h-fit" />
            ...
            <div className=" mx-3 sm:mx-2 md:mx-3 xl:mx-5 mt-3 mb-4">
                ...
                <div className=" flex justify-end items-end font-bold">{ConvertDate(product.createdAt)} น.</div>
            </div>
            </div>
        </div>
        </div>
