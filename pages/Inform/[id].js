...
const DetailInform = (props) => {
    ...
    return(
      ...
      `}</style>
            ...
            <div class="absolute left-2/2 -ml-0.5 w-1.5 rounded-md h-24 md:h-16 bg-gray-600"></div>
            <div > <h1 className="font-blod text-lg md:text-lg  ml-4">{product.title}</h1></div>
            </div>
