...
emailjs.sendForm('service_8qhwn8r', 'template_a0nrq3h', e.target, 'urzLahGarV18K7U0b')
  ...
  <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md mt-20">
      ...
      <form method='post' onSubmit={sendEmail2}  className="space-y-8">
          ...
          <div>
              <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">อีเมล์ของคุณ</label>
          ...
          <div>
              <label htmlFor="subject" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">ชื่อ-นามสกุลของคุณ</label>
